        ...
        <header className="bg-gray-100">
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline space-x-4">
                                ...
                                <Link href="/add-room" className="rounded-md px-3 py-2 text-sm font-medium text-gray-800 hover:bg-gray-700 hover:text-white">
                                    Add Room
                                </Link>
                            </div>
                        </div>
            ...
            <div className="md:hidden">
                <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                    ...
                    <Link href="/add-room" className="block rounded-md px-3 py-2 text-base font-medium text-gray-800 hover:bg-gray-700 hover:text-white">
                        Add Room
                    </Link>
                </div>
            </div>
