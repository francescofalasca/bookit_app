            ...
            <form className="mt-4" action={ formAction }>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            type="date" id="check_in_date" name="check_in_date"
                    ...
                    <div>
                        ...
                        <input
                            type="time" id="check_in_time"
                            name="check_in_time" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            required
                        />
                    </div>
                    <div>
